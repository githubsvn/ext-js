	...
	Ext.onReady(function(){
		...
		var grid = new Ext.grid.GridPanel({
			...
			columns: [
		      ...
		      {header: "Title", dataIndex: 'title', renderer: title_tagline, id: 'title', sortable: true},
		      {header: "Director", dataIndex: 'director', sortable: true},
		      {header: "Released", dataIndex: 'released', sortable: true,  
					renderer: Ext.util.Format.dateRenderer('m/d/Y'), width: 70},
		      {header: "Genre", dataIndex: 'genre', renderer: genre_name, sortable: true, width: 60},
		      {header: "Tagline", dataIndex: 'tagline', hidden: true},
			  {header: "Price", dataIndex: 'price', renderer: 'usMoney', sortable: true, width: 50}
		    ]
		 });
